...
var Module = typeof playground !== 'undefined' ? playground : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__sapp_emsc_notify_keyboard_hidden')) {
        Object.defineProperty(Module['ready'], '__sapp_emsc_notify_keyboard_hidden', { configurable: true, get: function() { abort('You are getting __sapp_emsc_notify_keyboard_hidden on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__sapp_emsc_notify_keyboard_hidden', { configurable: true, set: function() { abort('You are setting __sapp_emsc_notify_keyboard_hidden on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__sapp_emsc_onpaste')) {
        Object.defineProperty(Module['ready'], '__sapp_emsc_onpaste', { configurable: true, get: function() { abort('You are getting __sapp_emsc_onpaste on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__sapp_emsc_onpaste', { configurable: true, set: function() { abort('You are setting __sapp_emsc_onpaste on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__sapp_html5_get_ask_leave_site')) {
        Object.defineProperty(Module['ready'], '__sapp_html5_get_ask_leave_site', { configurable: true, get: function() { abort('You are getting __sapp_html5_get_ask_leave_site on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__sapp_html5_get_ask_leave_site', { configurable: true, set: function() { abort('You are setting __sapp_html5_get_ask_leave_site on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__sapp_emsc_begin_drop')) {
        Object.defineProperty(Module['ready'], '__sapp_emsc_begin_drop', { configurable: true, get: function() { abort('You are getting __sapp_emsc_begin_drop on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__sapp_emsc_begin_drop', { configurable: true, set: function() { abort('You are setting __sapp_emsc_begin_drop on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__sapp_emsc_drop')) {
        Object.defineProperty(Module['ready'], '__sapp_emsc_drop', { configurable: true, get: function() { abort('You are getting __sapp_emsc_drop on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__sapp_emsc_drop', { configurable: true, set: function() { abort('You are setting __sapp_emsc_drop on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__sapp_emsc_end_drop')) {
        Object.defineProperty(Module['ready'], '__sapp_emsc_end_drop', { configurable: true, get: function() { abort('You are getting __sapp_emsc_end_drop on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__sapp_emsc_end_drop', { configurable: true, set: function() { abort('You are setting __sapp_emsc_end_drop on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '__sapp_emsc_invoke_fetch_cb')) {
        Object.defineProperty(Module['ready'], '__sapp_emsc_invoke_fetch_cb', { configurable: true, get: function() { abort('You are getting __sapp_emsc_invoke_fetch_cb on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '__sapp_emsc_invoke_fetch_cb', { configurable: true, set: function() { abort('You are setting __sapp_emsc_invoke_fetch_cb on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
  wasmBinaryFile = 'playground.wasm';
...
if (typeof exports === 'object' && typeof module === 'object')
  ...
  define([], function() { return playground; });
